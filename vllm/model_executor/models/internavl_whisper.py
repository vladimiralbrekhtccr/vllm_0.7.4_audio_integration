...
class WhisperEncoder(WhisperPreTrainedModel):
    ...
    def forward(
        ...
        print("expected_seq_length",expected_seq_length)
        ...
        if audio_len_after_cnn is not None:
            input_mel_len = audio_len_after_cnn * 2 # 1478 * 2 = 2956
            max_mel_len_in_batch = int(input_mel_len.max()) # 2956
            input_features = input_features[:, :, :max_mel_len_in_batch] # [1, 128, 2956]
...
class AudioWhisperModel(WhisperPreTrainedModel):
    ...
    def forward(
        ...
        output = self.encoder( # self.encoder.forward(...) 
            input_features,
            attention_mask,
            audio_len_after_cnn,
            head_mask,
